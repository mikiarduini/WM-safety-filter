...
try:
    ...
    # Se MuJoCo non c'è, creiamo delle variabili "fantasma" impostate a None 
    # per evitare che il resto del codice vada in NameError!
    U_MAZE = None
    MEDIUM_MAZE = None
    LARGE_MAZE = None
    U_MAZE_EVAL = None
...
try:
    register(
        id='pushcube',
        entry_point='env.pushcube_wrapper:PushCubeWrapper',
    )
except Exception:
    pass
